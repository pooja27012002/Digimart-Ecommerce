...
export const SingleProduct = () => {
    const { productId, price, description, authorName, productName, quantity, imgUrl } = useLoaderData();
                ...
                <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-10">
                        ...
                        <div className="mt-6 sm:mt-8 lg:mt-0">
                            ...
                            >
                                <span className='font-bold'> {productName} </span>  (Nokia - {productId} , Mobile Phone Android)
                            </h1>
                            Delivery within 4-5 business days (Mobile)
